"""Main CLI entry point for FlyingHoneySnitch.
...
from flyinghoneysnitch import __app_name__, __version__
...
def cli(ctx: click.Context, config: str | None, verbose: bool) -> None:
    """FlyingHoneySnitch - Wireless Discovery & Assessment Tool Suite.
    ...
    from flyinghoneysnitch.utils.config import load_config
    from flyinghoneysnitch.utils.logger import setup_logging
...
from flyinghoneysnitch.cli.scan import scan  # noqa: E402
from flyinghoneysnitch.cli.export import export  # noqa: E402
from flyinghoneysnitch.cli.analyze import analyze  # noqa: E402
from flyinghoneysnitch.cli.monitor import monitor  # noqa: E402
from flyinghoneysnitch.cli.bluetooth import bluetooth  # noqa: E402
from flyinghoneysnitch.cli.cellular import cellular  # noqa: E402
from flyinghoneysnitch.cli.audit import audit  # noqa: E402
from flyinghoneysnitch.cli.isolation import isolation  # noqa: E402
...
@cli.command()
def gui():
    """Launch the FlyingHoneySnitch desktop GUI."""
    try:
        from flyinghoneysnitch.gui.app import main as gui_main
        gui_main()
    except ImportError:
        click.echo(
            "GUI dependencies not installed. Install with:\n"
            "  pip install flyinghoneysnitch[gui]",
            err=True,
        )
        raise SystemExit(1)
...
def info():
    ...
    # Permission check
    from flyinghoneysnitch.utils.permissions import check_permissions
    ...
    from flyinghoneysnitch.utils.interfaces import list_wireless_interfaces
