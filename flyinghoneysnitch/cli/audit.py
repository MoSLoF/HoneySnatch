"""Audit log CLI commands for FlyingHoneySnitch.

Provides `fhs audit` subcommands for verifying, viewing,
...
def audit_verify(data_dir: str) -> None:
    ...
    """
    from flyinghoneysnitch.utils.audit import get_audit_logger
