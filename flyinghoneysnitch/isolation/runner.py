...
from flyinghoneysnitch.isolation.config import (
    IsolationConfig,
    find_default_config,
    find_hostap_binary,
)
...
class IsolationTestRunner:
    ...
    def _gtk_check_live(self, iface2: str) -> AttackResult:
        ...
        from flyinghoneysnitch.isolation.supplicant import Supplicant
    ...
    def _c2c_live(self, iface2: str, mode: str) -> AttackResult:
        ...
        from flyinghoneysnitch.isolation.supplicant import Supplicant
        from flyinghoneysnitch.isolation.attacks.client2client import (
            create_c2c_result,
    ...
    def _c2m_live(self, monitor_iface: str, mode: str) -> AttackResult:
        ...
        from flyinghoneysnitch.isolation.supplicant import Supplicant
        from flyinghoneysnitch.isolation.libwifi.wifi import set_monitor_mode
    ...
    def _port_steal_live(
        ...
        from flyinghoneysnitch.isolation.supplicant import Supplicant
        from flyinghoneysnitch.isolation.libwifi.wifi import set_macaddress, restore_macaddress
    ...
    def _gw_bounce_live(self, iface2: str) -> AttackResult:
        ...
        from flyinghoneysnitch.isolation.supplicant import Supplicant
        from flyinghoneysnitch.isolation.attacks.gateway_bounce import (
    ...
    def _broadcast_reflection_live(self, iface2: str) -> AttackResult:
        ...
        from flyinghoneysnitch.isolation.supplicant import Supplicant
        from flyinghoneysnitch.isolation.attacks.broadcast_reflection import (
    ...
    def run_all(self, second_interface: str = "") -> IsolationTestSession:
        ...
        :meth:`~flyinghoneysnitch.db.database.DatabaseManager.save_isolation_session`.
        """
        iface2 = second_interface or self._second_iface
