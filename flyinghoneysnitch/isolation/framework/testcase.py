"""Test case abstraction with trigger/action model.

Adapted from AirSnitch's library/testcase.py.
Provides Trigger, Action, and Test classes for defining
structured Wi-Fi test cases.
"""
...
class Action:
    ...
    def __init__(self, trigger: int, action: int):
...
class Test(metaclass=abc.ABCMeta):
    ...
    def is_action_triggered(self, trigger: int) -> bool:
