"""Main window for the FlyingHoneySnitch desktop GUI."""
...
class MainWindow(QMainWindow):
    ...
    def _setup_tabs(self) -> None:
        ...
        # Import panels
        from flyinghoneysnitch.gui.panels.scan_panel import ScanPanel
        from flyinghoneysnitch.gui.panels.map_panel import MapPanel
        from flyinghoneysnitch.gui.panels.analysis_panel import AnalysisPanel
        from flyinghoneysnitch.gui.panels.monitoring_panel import MonitoringPanel
        from flyinghoneysnitch.gui.panels.bluetooth_panel import BluetoothPanel
        from flyinghoneysnitch.gui.panels.cellular_panel import CellularPanel
        from flyinghoneysnitch.gui.panels.isolation_panel import IsolationPanel
        ...
        self.isolation_panel = IsolationPanel(config=self.config)
        ...
        self.tabs.addTab(self.isolation_panel, "Isolation")
    ...
    def _open_session(self) -> None:
        ...
        path, _ = QFileDialog.getOpenFileName(
            self, "Open Session", "",
            "FlyingHoneySnitch Sessions (*.db);;All Files (*)",
        )
        if path:
    ...
    def _export(self, format: str) -> None:
        ...
        path, _ = QFileDialog.getSaveFileName(
            self, "Export Data",
            f"fhs_export_{session.session_id}.{format}",
        ...
        try:
            if format == "csv":
                ...
                from flyinghoneysnitch.mapping.export import export_kml
    ...
    def _show_about(self) -> None:
        ...
        QMessageBox.about(
            ...
            "<li><b>AirSnitch</b> - Client Isolation Testing</li>"
            "</ul>",
        )
