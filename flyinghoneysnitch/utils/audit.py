"""Tamper-evident audit logger for FlyingHoneySnitch.
...
from flyinghoneysnitch.utils.crypto import get_or_create_hmac_key, hmac_sha256
...
def get_audit_logger(data_dir: str = "") -> AuditLogger:
    ...
    Args:
        data_dir: Data directory.  If empty, uses ~/.local/share/flyinghoneysnitch.

    Returns:
        AuditLogger instance.
    """
    if not data_dir:
        data_dir = str(Path.home() / ".local" / "share" / "flyinghoneysnitch")
