"""Cryptographic utilities for FlyingHoneySnitch.
...
MAGIC = b"FHS\x01"  # FlyingHoneySnitch v1 encrypted format
...
def is_encrypted_file(path: str) -> bool:
    """Check if a file is FHS-encrypted by reading its magic bytes."""
    try:
