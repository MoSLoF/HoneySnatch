"""Configuration management for honeysnatch."""
...
from honeysnatch.isolation.config import IsolationConfig

DEFAULT_CONFIG_DIR = Path.home() / ".config" / "honeysnatch"
DEFAULT_DATA_DIR = Path.home() / ".local" / "share" / "honeysnatch"
